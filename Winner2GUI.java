/**
 *This class represents gui that means that the second player is the winner
 *@author Daniel and Olga
 */
public class Winner2GUI extends javax.swing.JFrame {

    /**
     *Winner2GUI constructor
     */
    public Winner2GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(41, 41, 41)
                    .addComponent(label2, javax.swing.GroupLayout.PREFERRED_SIZE, 386, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Winner2GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
      ...
      //show on screen the winner
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Winner2GUI().setVisible(true);
            }
        });
    }
